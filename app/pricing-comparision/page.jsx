...
export default function pricingcomparisionPage() {
  return (
    <>
                ...
                <div className="row justify-content-center">
                    <div className="col-md-7 col-lg-8">
                        <div className="hero-content-wrap text-white text-center position-relative">
                            <h1 className="text-white">Pricing Comparision</h1>
                            ...
                            <table className="table w-100 table-hover table-bordered comparision-table text-center">
                                <thead className="comparision-table-head">
                                    <tr className="active">
                                        ...
                                        className="badge bg-warning ms-2">Popular</span></strong>
                                ...
                                <tbody className="comparision-table-body">
                                    ...
                                    <tr>
                                        ...
                                        <td><span className="far fa-xmark-circle text-danger"></span></td>
                                        <td><span className="far fa-check-circle color-primary"></span></td>
                                        <td><span className="far fa-check-circle color-primary"></span></td>
                                    </tr>
                            ...
                            <table className="table w-100 table-hover table-bordered comparision-table text-center">
                                ...
                                <tbody className="comparision-table-body">
                                    ...
                                    <tr>
                                        ...
                                        <td><span className="far fa-circle-xmark text-danger"></span></td>
                                        <td><span className="far fa-check-circle color-primary"></span></td>
                                        <td><span className="far fa-check-circle color-primary"></span></td>
                                    </tr>
