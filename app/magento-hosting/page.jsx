...
export default function magentohostingPage() {
  return (
    <>
                ...
                <div className="row align-items-center justify-content-lg-between">
                    <div className="col-md-6 col-lg-5">
                        <div className="hero-content-wrap text-white position-relative">
                            <h1 className="text-white">Unlimited Magento 2 Web Hosting with SSD</h1>
                    ...
                    <div className="col-md-6 col-lg-6">
                        <div className="img-wrap text-lg-end">
                            <img src="/assets/img/magento-hosting.svg" alt="email hosting" className="img-fluid" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section className="pricing-section ptb-100">
            <div className="container">
                ...
                <div className="row g-4 align-items-center justify-content-between">
                    <div className="col-12">
                        <div className="switch-wrap text-center mb-2">
                    ...
                    <div className="col-lg-4 col-md-4 col-12">
                        <div className="card text-center single-pricing-pack">
                            ...
                            <div className="card-body">
                                ...
                                <a href="#" className="btn btn-outline-primary mb-3" target="_blank">Purchase now</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-4 col-12">
                        <div className="card popular-price text-center single-pricing-pack">
                            <div className="pt-5">
                                <h5 className="mb-0">Cloud Business <span className="badge bg-warning ms-2">Popular</span></h5>
                            ...
                            <div className="card-body">
                                ...
                                <a href="#" className="btn btn-primary mb-3" target="_blank">Purchase now</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-4 col-12">
                    ...
                    <div className="col-12">
                        <div className="support-cta mt-2">
                            <h6 className="mb-1 d-flex align-items-center justify-content-center"><span
                            className="fas fa-rotate-left color-primary me-2 icon-sm"></span>Choose Your <a href="/pricing-comparison" className="ms-2">Compare Hosting Plans</a></h6>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="row align-items-center">
                    <div className="col-md-6 col-lg-6">
                        <div className="cta-new-wrap">
                            <h2>Cloud Hosting Is Faster, Stronger, Dedicated</h2>
                            <p>Synergistically envisioneer proactive core competencies without out-of-the-box imperatives. Progressively visualize mission-critical convergence without low-risk high-yield functionalities. Assertively leverage other's functionalized products whereas principle-centered niche markets. Compellingly matrix installed base web services after bricks-and-clicks niches. Interactively pursue team driven "outside the box" thinking without customer directed web-readiness.</p>
                            <ul className="list-unstyled tech-feature-list">
                                <li className="py-1"><span className="fas fa-angle-double-right me-2 color-primary"></span>Flexible, Easy to
                                    Use Control Panel</li>
                                <li className="py-1"><span className="fas fa-angle-double-right me-2 color-primary"></span><strong>Unmetered
                            </strong> Bandwidth</li>
                                <li className="py-1"><span className="fas fa-angle-double-right me-2 color-primary"></span><strong>Unmetered
                            </strong> Sub Domains, FTP Accounts</li>
                                <li className="py-1"><span className="fas fa-angle-double-right me-2 color-primary"></span><strong>99
                                %</strong> Uptime Guarantee</li>
                                <li className="py-1"><span className="fas fa-angle-double-right me-2 color-primary"></span><strong>45
                                -Day</strong> Money-Back Guarantee</li>
                            </ul>
                            <div className="action-btns mt-4">
                                <a href="#" className="btn btn-primary">Get
                                    Started Now</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-6">
                        <div className="cta-new-wrap">
                            <img src="/assets/img/private-cloud-server.svg" alt="hosting" className="img-fluid" />
                        </div>
                    </div>
                </div>
            </div>
