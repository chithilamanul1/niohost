...
export default function offersinglepagePage() {
  return (
    <>
    ...
    <div className="main">
        ...
        <section className="hero-equal-height ptb-120 gradient-overlay bg-image" data-overlay="8">
                        ...
                        <div className="single-offer-wrap d-flex align-items-center justify-content-center">
                            <div className="offer-content-wrap">
                                ...
                                <div className="offer-content text-white">
                                    ...
                                    <div className="h1 starting-price mb-0 text-white">
                                        60%<small>Off</small>
                                    </div>
                                </div>
