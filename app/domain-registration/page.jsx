...
export default function domainregistrationPage() {
  return (
    ...
    <div className="main">
        ...
        <section className="ptb-120 gradient-bg hero-equal-height">
            <div className="container">
                <div className="row align-items-center justify-content-center">
                    <div className="col-md-10 col-lg-8 col-xl-6">
                        <div className="hero-content-wrap text-white position-relative text-center">
                            <h1 className="text-white">Register Your Domain Name Get 24/7 Support.</h1>
            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-9 col-lg-6">
                        <div className="section-heading text-center mb-5">
                            <h2>10 FREE Services With your Domain Name</h2>
                            <p>Uniquely promote real-time strategic theme areas whereas global relationships. Collaborative action items and market positioning e-markets.</p>
                        </div>
                    </div>
                </div>
                <div className="row align-items-center justify-content-around">
                    <div className="col-md-6 col-lg-6">
                        <ul className="list-unstyled tech-feature-list">
                            <li className="py-1"><i className="fas fa-check-circle text-success me-2"></i><span
                            className="text-success">Free </span><strong>support</strong> in English</li>
                            <li className="py-1"><i className="fas fa-check-circle text-success me-2"></i><span
                            className="text-success">Free </span>User-friendly control panel</li>
                            <li className="py-1"><i className="fas fa-check-circle text-success me-2"></i><span
                            className="text-success">Free </span><strong>90-day money-back guarantee</strong></li>
                            <li className="py-1"><i className="fas fa-check-circle text-success me-2"></i><span
                            className="text-success">Free </span><strong>e-mail marketing</strong> with Flexmail</li>
                            <li className="py-1"><i className="fas fa-check-circle text-success me-2"></i><span
                            className="text-success">Free </span><strong>Google Ads voucher</strong></li>
                        </ul>
                    </div>
                    <div className="col-md-6 col-lg-6">
                        <ul className="list-unstyled tech-feature-list">
                            <li className="py-1"><i className="fas fa-check-circle text-success me-2"></i><span
                            className="text-success">Free </span><strong>1 GB</strong> mailbox and e-mail address</li>
                            <li className="py-1"><i className="fas fa-check-circle text-success me-2"></i><span
                            className="text-success">Free </span>Unlimited number of <strong>subdomains</strong></li>
                            <li className="py-1"><i className="fas fa-check-circle text-success me-2"></i><span
                            className="text-success">Free </span>Full control over the <strong>DNS settings</strong></li>
                            <li className="py-1"><i className="fas fa-check-circle text-success me-2"></i><span
                            className="text-success">Free </span>Unlimited e-mail aliases for <strong>mail forwarding</strong></li>
                            <li className="py-1"><i className="fas fa-check-circle text-success me-2"></i><span
                            className="text-success">Free </span>Forward your visitors thanks to <strong>domain forwarding</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section className="feature-tab-section ptb-100 gray-light-bg">
            <div className="container">
