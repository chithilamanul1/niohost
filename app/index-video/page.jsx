...
export default function indexvideoPage() {
  return (
    ...
    <div className="main">
                ...
                <div className="row align-items-center justify-content-center">
                    <div className="col-md-8 col-lg-8">
                        <div className="hero-content-left text-white text-center">
                            <h1 className="text-white display-4 fw-bold">Expert Cloud Strategy & Consulting</h1>
                            <p className="lead mb-4">Expert cloud consulting to support you as you grow. Improving your existing solution and planning next steps, we work closely with you to help. </p>
                            <a href="#" className="btn btn-primary btn-lg"><i className="far fa-comments me-2"></i> Start a live
                                chat</a>
                        </div>
                    </div>
                </div>
        ...
        <section className="promo-section mt-n-150 ">
            <div className="container">
                <div className="row">
                    <div className="col-md-6 col-lg-4">
                        <div className="card hosting-promo border-0 rounded-custom p-4 mt-4 shadow">
                            <div className="card-body">
                                <div className="hosting-promo-icon mb-3 d-flex justify-content-between">
                                    <span className="fas fa-cloud icon-size-lg color-primary"></span>
                                </div>
                                <div className="hosting-promo-content">
                                    <h5 className="h6">Cloud Hosting</h5>
                                    <p>Phosfluorescently target viral expedite empowered bleeding sources through.</p>
                                    <a href="#" target="_blank" className="read-more-link d-inline-flex align-items-center">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="card hosting-promo border-0 rounded-custom p-4 mt-4 shadow">
                            <div className="card-body">
                                <div className="hosting-promo-icon mb-3 d-flex justify-content-between">
                                    <span className="fas fa-hdd icon-size-lg color-primary"></span>
                                </div>
                                <div className="hosting-promo-content">
                                    <h5 className="h6">VPS Web Hosting</h5>
                                    <p>Bleeding sources through viral deploy go forward target expedite empowered.</p>
                                    <a href="#" target="_blank" className="read-more-link d-inline-flex align-items-center">
                                        <span>Read More</span> <i className="fas fa-arrow-right ms-2"></i>
                                    </a>
                                </div>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="card hosting-promo border-0 rounded-custom p-4 mt-4 shadow">
                            <div className="card-body">
                                ...
                                <div className="hosting-promo-content">
                                    <h5 className="h6">Email Hosting</h5>
                                    <p>Phosfluorescently target viral expedite empowered bleeding sources through.</p>
                                    <a href="#" target="_blank" className="read-more-link d-inline-flex align-items-center">
                                        <span>Read More</span> <i className="fas fa-arrow-right ms-2"></i>
                                    </a>
        ...
        <section className="ptb-100 service-section-wrap">
            <div className="container">
              ...
              Website Building
                                ...
                                <span className="fas fa-code fa-3x color-primary"></span>
                            </div>
                            <p>
                            ...
                            <a href="#" className="btn btn-outline-primary mt-3">View more details</a>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-6">
                        <div className="single-service p-5 rounded border gray-light-bg">
                            <div className="service-header d-flex align-items-center justify-content-between">
                                <h4>
                                    <span className="h5 text-uppercase">Suitable For All Users</span>
                                    <br />
              Managed WordPress
                                </h4>
              ...
              Website Transfer
                                ...
                                <span className="fas fa-paper-plane fa-3x color-primary"></span>
                            </div>
                            <p>
                                Globally fashion client-focused synergy for accurate synergy.
                                Quickly network cost effective ideas rather than standardized
        ...
        <div className="feature-section ptb-100 gray-light-bg">
            <div className="container">
                <div className="row align-items-center justify-content-between">
                    <div className="col-md-7 col-lg-5">
                        <div className="feature-content-wrap">
                            ...
                            <a href="/about-us" className="read-more-link">Know more about us <i
