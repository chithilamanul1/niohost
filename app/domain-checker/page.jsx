...
export default function domaincheckerPage() {
  return (
    ...
    <div className="main">
                ...
                <div className="row align-items-center justify-content-lg-between">
                    <div className="col-md-6 col-lg-5">
                        <div className="hero-content-wrap text-white position-relative">
                            <h1 className="text-white">Find Best Unique Domains Use Domain Checker!</h1>
                            ...
                            <div className="domain-checker-wrap">
                                <form action="domain-search-result.php" className="domain-transfer-form newsletter-form position-relative w-75">
                                    <input type="text" name="domain" id="domain" className="form-control rounded-pill" placeholder="yourdomain.com" />
                                    <button type="submit" className="btn btn-tertiary">Check now</button>
                                </form>
                                <div className="domain-list-wrap mt-4">
                                    <ul className="list-inline domain-search-list">
                                        <li className="list-inline-item border rounded"><a href="#"><img src="assets/img/com-w.png" alt="com" width="60" className="img-fluid" /> <span>$8.99</span></a>
                                        </li>
                                        <li className="list-inline-item border rounded"><a href="#"><img src="assets/img/online-w.png" alt="com" width="60" className="img-fluid" /> <span>$0.99</span></a>
                                        </li>
                                        <li className="list-inline-item border rounded"><a href="#"><img src="assets/img/net-w.png" alt="com" width="60" className="img-fluid" /> <span>$4.99</span></a>
                                        </li>
                                        <li className="list-inline-item border rounded"><a href="#"><img src="assets/img/org-w.png" alt="com" width="60" className="img-fluid" /> <span>$2.99</span></a>
                                        </li>
                                        <li className="list-inline-item border rounded"><a href="#"><img src="assets/img/store-w.png" alt="com" width="60" className="img-fluid" /> <span>$0.99</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="col-md-6 col-lg-6">
                        <div className="img-wrap text-lg-end">
                            <img src="assets/img/domain-checker.svg" alt="domain registration" className="img-fluid" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-6 col-lg-4">
                        <div className="single-popular-domain position-relative bg-white rounded p-4 mt-sm-4 mt-md-5 mt-lg-4">
                            <img src="assets/img/com.png" alt="domain" className="img-fluid" />
                            <div className="domain-info-wrap">
                                <span className="position-absolute badge bg-warning">Most Popular</span>
                                ...
                                <ul className="list-inline domain-price-list">
                                    ...
                                    <li className="list-inline-item domain-new-price">$8.99</li>
                                </ul>
                            </div>
                            <div className="action-btns mt-3">
                                <a href="#" className="btn btn-primary btn-sm me-2">Register</a>
                                <a href="#" className="btn btn-outline-primary btn-sm">Transfer</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-4">
                        <div className="single-popular-domain position-relative bg-white rounded p-4 mt-sm-4 mt-md-5 mt-lg-4">
                            <img src="assets/img/online.png" alt="domain" className="img-fluid" />
                            <div className="domain-info-wrap">
                                ...
                                <ul className="list-inline domain-price-list">
                                    ...
                                    <li className="list-inline-item domain-new-price">$0.99</li>
                                </ul>
                            </div>
                            <div className="action-btns mt-3">
                                <a href="#" className="btn btn-primary btn-sm me-2">Register</a>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="single-popular-domain position-relative bg-white rounded p-4 mt-sm-4 mt-md-5 mt-lg-4">
                            <img src="assets/img/club.png" alt="domain" className="img-fluid" />
                            <div className="domain-info-wrap">
                                ...
                                <ul className="list-inline domain-price-list">
                                    ...
                                    <li className="list-inline-item domain-new-price">$6.99</li>
                                </ul>
                            </div>
                            <div className="action-btns mt-3">
                                <a href="#" className="btn btn-primary btn-sm me-2">Register</a>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="single-popular-domain position-relative bg-white rounded p-4 mt-sm-4 mt-md-5 mt-lg-4">
                            <img src="assets/img/net.png" alt="domain" className="img-fluid" />
                            <div className="domain-info-wrap">
                                ...
                                <ul className="list-inline domain-price-list">
                                    ...
                                    <li className="list-inline-item domain-new-price">$4.99</li>
                                </ul>
                            </div>
                            <div className="action-btns mt-3">
                                <a href="#" className="btn btn-primary btn-sm me-2">Register</a>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="single-popular-domain position-relative bg-white rounded p-4 mt-sm-4 mt-md-5 mt-lg-4">
                            <img src="assets/img/pro.png" alt="domain" className="img-fluid" />
                            <div className="domain-info-wrap">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="single-popular-domain position-relative bg-white rounded p-4 mt-sm-4 mt-md-5 mt-lg-4">
                            <img src="assets/img/org.png" alt="domain" className="img-fluid" />
                            <div className="domain-info-wrap">
        ...
        <section className="domain-pricing-section ptb-100">
            <div className="container">
                <div className="row justify-content-center">
                ...
                <div className="row">
                    <div className="col-sm-12">
                        <div className="table-responsive-lg">
                            <table className="table table-bordered domain-price-table">
                                <thead>
                                    <tr>
                                        <td className="dp-title">Extensions (TLD)</td>
                                        <td className="dp-title">Register</td>
                                        <td className="dp-title">Renew</td>
                                        <td className="dp-title">Transfer</td>
                                    </tr>
                                </thead>
                                <tbody className="domain-price-body">
                                    <tr>
                                        <td><span className="domain-extension">.com</span> <span className="badge bg-success"> popular
                                    </span></td>
                                        <td>$12.00</td>
                                        <td>$14.90</td>
                                        <td>$14.90</td>
                                    ...
                                    <tr>
                                        <td><span className="domain-extension">.info</span>
                                            <span className="badge bg-danger">sale</span>
                                        </td>
                                        <td><del>$11.90</del> <b className="color-accent">$7.99</b></td>
                                        <td>$11.90</td>
                                        <td>$14.00</td>
                                    </tr>
                                    <tr>
                                        <td><span className="domain-extension">.org</span></td>
                                        <td>$8.00</td>
                                        <td>$10.90</td>
                                        <td>$10.90</td>
                                    </tr>
                                    <tr>
                                        <td> <span className="domain-extension">.co.uk</span></td>
                                        <td>$25.00</td>
                                        <td>$30.90</td>
                                        <td>$30.90</td>
                                    </tr>
                                    <tr>
                                        <td><span className="domain-extension">.gov</span></td>
                                        <td>$45.24</td>
                                        <td>$50.24</td>
                                        <td>$50.00</td>
                                    </tr>
                                    <tr>
                                        <td><span className="domain-extension">.store</span></td>
                                        <td>$32.00</td>
                                        <td>$35.90</td>
                                        <td>$35.90</td>
                                    </tr>
                                    <tr>
                                        <td><span className="domain-extension">.blog</span> <span className="badge bg-danger">sale
                                    </span></td>
                                        <td><del>$45.10</del> <b className="color-accent">$26.00</b></td>
                                        <td>$55.10</td>
                                        <td>$55.10</td>
                                    </tr>
                                    <tr>
                                        <td><span className="domain-extension">.online</span></td>
                                        <td>$22.00</td>
                                        <td>$46.90</td>
                                        <td>$46.90</td>
                                    </tr>
                                    <tr>
                                        <td><span className="domain-extension">.eu</span></td>
                                        <td>$3.80</td>
                                        <td>$5.80</td>
                                        <td>$6.00</td>
                                    </tr>
                                    <tr>
                                        <td><span className="domain-extension">.pt</span></td>
                                        <td>$10.00</td>
                                        <td>$12.00</td>
                                        <td>$15.90</td>
                                    </tr>
                                    <tr>
                                        <td> <span className="domain-extension">.company</span>
                ...
                <div className="row align-items-center justify-content-between">
                    <div className="col-12 col-lg-6">
                        ...
                        <div className="support-action d-inline-flex flex-wrap">
                            <a href="mailto:support@yourdomain.com" className="me-3 text-info"><i className="fas fa-comment me-1 text-tertiary"></i>
                                <span>support@yourdomain.com</span></a>
                            <a href="tel:+00123456789" className="mb-0 text-info"><i className="fas fa-phone-alt me-1 text-tertiary"></i>
