...
export default function windowsvpshostingPage() {
  return (
    <>
    ...
    <div className="main">
                ...
                <div className="row align-items-center justify-content-lg-between">
                    <div className="col-md-7 col-lg-5">
                        <div className="hero-content-wrap text-white">
                            <h1 className="text-white">Windows VPS Server Hosting Up to 50% OFF</h1>
        ...
        <section id="features" className="feature-tab-section ptb-100 gray-light-bg">
            <div className="container">
                <div className="row align-items-center justify-content-lg-between">
                    <div className="col-xl-5 col-lg-5 col-12 order-lg-last align-self-center">
                        <div className="image-box fadein text-xl-right text-center">
                            <img src="assets/img/email-feature-img.jpg" alt="wp-hosting" className="img-fluid" />
                        </div>
                    </div>
                    <div className="col-xl-6 col-lg-7 col-12 order-xl-first">
                ...
                <div className="row align-items-center justify-content-lg-between mt-5">
                    <div className="col-xl-5 col-lg-5 col-12 order-lg-last align-self-center">
                        <div className="image-box fadein text-xl-right text-center">
                            <img src="assets/img/macbook.png" alt="wp-hosting" className="img-fluid" />
                        </div>
                    </div>
                    <div className="col-xl-6 col-lg-7 col-12 order-xl-last">
