                        ...
                        <div className="contact-us-form-wrap gray-light-bg position-relative">
                            <form action="" method="POST" id="contactForm" className="contact-us-form">
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="col-md-9 col-12">
                                        <div className="mb-4">
                                            <textarea name="message" id="message" className="form-control w-100 h-100" rows="5" cols="25" placeholder="Message"></textarea>
                                        </div>
                                    </div>
                                    <div className="col-sm-12 mt-3">
                                        <button type="submit" className="btn btn-primary" id="btnContactUs">
                                            Send Message
                                        </button>
                                    </div>
                                </div>
                                ...
                                <ul className="contact-info-list mt-3">
                                    <li className="d-flex py-3">
                                        <div className="contact-icon me-3">
                                            <span className="fas fa-location-arrow text-tertiary"></span>
                                        </div>
                                    ...
                                    <li className="d-flex py-3">
                                        <div className="contact-icon me-3">
                                            <span className="fas fa-envelope text-tertiary"></span>
                                        </div>
                                        <div className="contact-text">
                                            <h6 className="mb-1 text-white font-weight-normal">
                                                Email Address
