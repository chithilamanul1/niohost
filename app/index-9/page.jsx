...
export default function index9Page() {
  return (
    ...
    <div className="main">
        ...
        <section className="hero_area_9 pb-120">
            <div className="container">
                <div className="row align-items-center justify-content-between g-4">
                    <div className="col-md-6 col-lg-5 col-xl-4">
                        <div className="headline mb-4">
                            <p className="text-white mb-0"><i className="fas fa-bell rounded-circle mr-2"></i> <span className="fw-bold">30% Discount
                        </span> first annual purchase</p>
                        </div>
                        <h1 className="text-white">Unlock Your Digital Potential Today</h1>
                        <ul className="list-unstyled d-flex flex-column gap-3 mb-0 pt-5">
                            <li className="d-flex align-items-center gap-2">
                                <span className="fas fa-check-circle text-success"></span>
                                <p className="text-white mb-0">Free domain and website migration</p>
                            </li>
                            <li className="d-flex align-items-center gap-2">
                                <span className="fas fa-check-circle text-success"></span>
                                <p className="text-white mb-0">Quick setup, easy to scale</p>
                            </li>
                            <li className="d-flex align-items-center gap-2">
                                <span className="fas fa-check-circle text-success"></span>
                                <p className="text-white mb-0">24/7 customer support</p>
                            </li>
                        </ul>
                ...
                <div className="row justify-content-center">
                    <div className="col-md-9 col-lg-6">
                        <div className="section-heading text-center mb-5">
                            <h2 className="mb-0">Choose Your Web Hosting Plan</h2>
                        </div>
                    </div>
                </div>
        ...
        <section className="bg-body-9 pt-120 pb-40">
            <div className="container">
                    ...
                    <div className="col-md-6">
                        <div className="ps-xl-4">
                            <div className="section-heading mb-5">
                                <h2 className="mb-0">Total security. <br /> Complete confidence.</h2>
                            </div>
                            <ul className="list-unstyled d-flex flex-column gap-3 mb-0">
                                <li className="d-flex gap-2">
                                    <span className="fas fa-check text-dark mt-2"></span>
                                    <p className="text-dark max-text-40 mb-0">Secure your files with regular automatic backups and two-factor authentication</p>
                                </li>
                                <li className="d-flex gap-2">
                                    <span className="fas fa-check text-dark mt-2"></span>
                                    <p className="text-dark max-text-40 mb-0">Encrypt your website traffic with unlimited SSL security certificates</p>
                                </li>
                                <li className="d-flex gap-2">
                                    <span className="fas fa-check text-dark mt-2"></span>
                                    <p className="text-dark max-text-40 mb-0">Enjoy full protection from DDoS attacks with Cloudflare protected nameservers</p>
                                </li>
                            </ul>
                            <div className="action-btns mt-4">
        ...
        <section className="bg-body-9 pt-40 pb-120">
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-9 col-lg-6">
                        <div className="section-heading text-center mb-5">
                            <h2>Speed. Reliability. Efficiency.</h2>
                            <p> Professional hosting at an affordable price. Distinctively recaptiualize principle-centered core competencies through client-centered core competencies. </p>
                        </div>
                    </div>
                </div>
        ...
        <section className="pt-40 pb-120">
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-9 col-lg-6">
                        <div className="section-heading text-center mb-5">
                            <h2 className="h4 mb-0">Recommended by WordPress.org</h2>
                        </div>
                    </div>
                </div>
                <div className="row justify-content-center">
        ...
        <section className="bg-primary pt-80 pb-80">
            <div className="container">
                <div className="row align-items-center g-4">
                    <div className="col-md-6">
                        <div className="section-heading mb-4">
                            <h2 className="text-white mb-0">Here to help 24/7</h2>
                        </div>
                        <ul className="list-unstyled d-flex flex-column gap-3 mb-0">
                            <li className="d-flex gap-2">
                                <span className="fas fa-check text-white mt-2"></span>
                                <p className="text-white max-text-40 mb-0">Access expert support whenever you need it via live chat and email</p>
                            </li>
                            <li className="d-flex gap-2">
                                <span className="fas fa-check text-white mt-2"></span>
                                <p className="text-white max-text-40 mb-0">Our specialists are fluent in 8+ languages so you can be sure communication will be smooth</p>
                            </li>
                            <li className="d-flex gap-2">
                                <span className="fas fa-check text-white mt-2"></span>
                                <p className="text-white max-text-40 mb-0">Spend less time waiting, our speedy support team typically responds in under 2 minutes</p>
                            </li>
                        </ul>
                        <div className="action-btns mt-4">
                            <a href="#" className="btn btn-tertiary mr-3">Get Started</a>
        ...
        <section id="faq" className="pt-120 pb-60">
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-9 col-lg-6">
                        <div className="section-heading text-center mb-5">
        ...
        <section className="pt-60 pb-60">
            <div className="container">
                <div className="bg-primary pt-80 pb-80 px-5 rounded-3">
                    <div className="row align-items-center justify-content-between g-4">
                        <div className="col-lg-7">
                            <div className="section-heading mb-4">
                                <h2 className="text-white mb-0">Best Cloud Hosting With Trusted Service</h2>
                            </div>
                            <p className="text-white mb-4">Objectively innovate high standards in methodologies vis-a-vis sustainable compellingly architect front-end methods maintain multidisciplinary process proactively streamline mission-critical information via quality imperatives.</p>
                            <a href="#" className="btn btn-tertiary mr-3">Get Started</a>
                        </div>
        ...
        <section className="client-section pt-60 pb-120">
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-6">
                        <div className="section-heading text-center mb-5">
