...
export default function sharedhostingPage() {
  return (
    ...
    <div className="main">
            ...
            <div className="hero-slider-one swiper">
                <div className="swiper-wrapper">
                    <div className="swiper-slide">
                        <div className="item">
                            <div className="bg-image hero-equal-height ptb-120" data-overlay="8">
                                <div className="background-image-wraper" style={{ background: 'url(assets/img/hero-1.jpg)' }}></div>
                                <div className="container">
    							...
    							>Reliable hosting to make any website</span>
                                                <h1 className="text-white">
                                                    We Offer Shared Hosting Fast, Secure & Easy To Manage
                                                </h1>
                                                <ul className="list-unstyled tech-feature-list">
                                                    <li className="py-1">
                                                        <span className="fas fa-check-circle text-success me-2"></span><strong>Unmetered</strong> Sub Domains, Accounts
                                                    </li>
                                                    <li className="py-1">
                                                        <span className="fas fa-check-circle text-success me-2"></span><strong>99%</strong> Uptime Guarantee
                                                    </li>
                                                    <li className="py-1">
                                                        <span className="fas fa-check-circle text-success me-2"></span><strong>45-Day</strong> Money-Back Guarantee
                                                    </li>
                                                </ul>
    							...
    							>Regular Price <strong>$10.99</strong> *</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="swiper-slide">
                        <div className="item">
                            <div className="bg-image hero-equal-height ptb-120" data-overlay="8">
                                <div className="background-image-wraper" style={{ background: 'url(assets/img/hero-4.jpg)' }}></div>
                                <div className="container">
                                    <div className="row">
                                        <div className="col-md-8 col-lg-7">
                                            <div className="hero-content-wrap text-white">
                                                <span className="text-white h5 font-weight-normal"
    							>Trusted by 700,500 Website Owners</span>
                                                <h1 className="text-white">
                                                    Your Websites Deserve Faster, Secure & Reliable Hosting
                                                </h1>
                                                <ul className="list-unstyled tech-feature-list">
                                                    <li className="py-1">
                                                        <span className="fas fa-check-circle text-success me-2"></span>Industry-leading Performance & Speed
                                                    </li>
                                                    <li className="py-1">
                                                        <span className="fas fa-check-circle text-success me-2"></span>Free & Effortless Migration
                                                    </li>
                                                    <li className="py-1">
                                                        <span className="fas fa-check-circle text-success me-2"></span>Free SSL Certificates For ALL Websites
                                                    </li>
                                                    <li className="py-1">
                                                        <span className="fas fa-check-circle text-success me-2"></span>99.9% Uptime Guarantee
                                                    </li>
                                                    <li className="py-1">
                                                        <span className="fas fa-check-circle text-success me-2"></span>30-day Money-back Guarantee
                                                    </li>
                                                </ul>
                                                <div className="action-btns mt-4">
                                                    <a href="#" className="btn btn-tertiary me-3">Explore Plans</a>
                    ...
                    <div className="swiper-slide">
                        <div className="item">
                            <div className="bg-image hero-equal-height ptb-120" data-overlay="8">
                                <div className="background-image-wraper" style={{ background: 'url(assets/img/hero-5.jpg)' }}></div>
                                <div className="container">
                                    <div className="row">
                                        <div className="col-md-8 col-lg-7">
                                            <div className="hero-content-wrap text-white">
    							...
    							>Build your own website</span>
                                                <h1 className="text-white">
                                                    Own VPS, Fully Managed by Experts, Simple, affordable
                                                </h1>
                                                <ul className="list-unstyled tech-feature-list">
                                                    <li className="py-1">
                                                        <span className="fas fa-check-circle text-success me-2"></span>24/7 fully managed support
                                                    </li>
                                                    <li className="py-1">
                                                        <span className="fas fa-check-circle text-success me-2"></span>Industry-leading performance & load speed
                                                    </li>
                                                    <li className="py-1">
                                                        <span className="fas fa-check-circle text-success me-2"></span>Robust control panel & advanced security
                                                    </li>
                                                    <li className="py-1">
                                                        <span className="fas fa-check-circle text-success me-2"></span>99.9% Uptime Guarantee
                                                    </li>
                ...
                <div className="row align-items-center justify-content-md-center justify-content-center">
                    <div className="col-lg-4 col-md-6 col-sm-8">
                        <div className="popular-price bg-white pricing-new-wrapper mt-4 p-5 shadow-sm border">
                            <div className="pricing-price d-flex justify-content-between align-items-center pb-4">
                                <span className="p-icon">
                  <i className="fas fa-rocket color-secondary"></i>
                </span>
                                <div className="h2 mb-0 text-dark"> $5.99 <span className="price-cycle h5">/mo</span>
                                </div>
                            </div>
                            <div className="pricing-info">
                                <h5>Basic</h5>
                                <p className="text-muted"> High performance, low cost hosting with SSD for the perfect starter plan. </p>
                            </div>
                            <div className="pricing-content">
                                <ul className="list-unstyled pricing-feature-list-2 mt-4 mb-3">
                                    <li>
                                        <i className="far fa-hdd me-2"></i>
                                        <p>
                                            <strong>5GB</strong> SSD Disk Space
                                        </p>
                                        <span className="text-under-line" data-bs-toggle="tooltip" data-bs-placement="top" title=""
                      ...
                      <i className="fas fa-info-circle ms-1"></i>
                                    ...
                                    <li>
                                        <i className="fas fa-safari me-2"></i>
                                        <p>
                      ...
                      <i className="fas fa-info-circle ms-1"></i>
                                ...
                                <a href="/pricing-specifications" className="mb-4 d-block read-more-link">Full specifications <i
                    className="fas fa-arrow-right ps-2"></i>
                                </a>
                                <a href="#" className="btn btn-primary btn-block" target="_blank">Purchase Now</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6 col-sm-8">
                        <div className="popular-price bg-white pricing-new-wrapper mt-4 p-5 shadow-sm border">
                            <div className="pricing-price d-flex justify-content-between align-items-center pb-4">
                                <span className="p-icon">
                  <i className="fas fa-space-shuttle color-secondary"></i>
                </span>
                                <div className="h2 mb-0 text-dark"> $8.99 <span className="price-cycle h5">/mo</span>
                                </div>
                            </div>
                            <div className="pricing-info">
                                <h5>Starter</h5>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-8">
                        <div className="popular-price bg-white pricing-new-wrapper mt-4 p-5 shadow-sm border">
                            <div className="pricing-price d-flex justify-content-between align-items-center pb-4">
                                <span className="p-icon">
                  <i className="fas fa-medal color-secondary"></i>
                </span>
                                <div className="h2 mb-0 text-dark"> $12.99 <span className="price-cycle h5">/mo</span>
                                </div>
                            </div>
                            <div className="pricing-info">
                                <h5>Professional</h5>
                    ...
                    <div className="col-12">
                        <div className="support-cta text-center mt-5">
                            <a href="/pricing-comparision" target="_blank">
                                <h5 className="mb-1">
                                    <span className="fas fa-rotate-left color-primary me-2"></span>Compare Hosting Plans
                                </h5>
                            </a>
                        </div>
                    </div>
        ...
        <section className="appliction-hosting ptb-100 gray-light-bg">
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-9 col-lg-6">
                        <div className="section-heading text-center mb-5">
                            <h2>Available Operating Systems With Maximum Speed</h2>
                            <p>Our web hosting platform has been fully optimised to offer outstanding performance for your web applications, delivering speeds of up to16x faster.</p>
                        </div>
                    </div>
                </div>
                <div className="row">
