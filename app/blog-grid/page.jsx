            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-6 col-lg-4">
                        <a className="single-blog-article rounded bg-white border d-block mt-4" href="/blog-details">
                            <div className="blog-img mb-2">
                                <img src="/assets/img/blog/1.jpg" className="rounded-top img-fluid" alt="blog" />
                            </div>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <a className="single-blog-article rounded bg-white border d-block mt-4" href="/blog-details">
                            <div className="blog-img mb-2">
                                <img src="/assets/img/blog/2.jpg" className="rounded-top img-fluid" alt="blog" />
                            </div>
                            <div className="blog-content-wrap p-4">
                                <div className="article-heading">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <a className="single-blog-article rounded bg-white border d-block mt-4" href="/blog-details">
                            <div className="blog-img mb-2">
                                <img src="/assets/img/blog/3.jpg" className="rounded-top img-fluid" alt="blog" />
                            </div>
                            <div className="blog-content-wrap p-4">
                                <div className="article-heading">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <a className="single-blog-article rounded bg-white border d-block mt-4" href="/blog-details">
                            <div className="blog-img mb-2">
                                <img src="/assets/img/blog/4.jpg" className="rounded-top img-fluid" alt="blog" />
                            </div>
                            <div className="blog-content-wrap p-4">
                                <div className="article-heading">
                                    <h3 className="h5 mb-0">Monotonectally promote market</h3>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <a className="single-blog-article rounded bg-white border d-block mt-4" href="/blog-details">
                            <div className="blog-img mb-2">
                                <img src="/assets/img/blog/5.jpg" className="rounded-top img-fluid" alt="blog" />
                            </div>
                            <div className="blog-content-wrap p-4">
                                <div className="article-heading">
                                    <h3 className="h5 mb-0">Professionally cultivate testing</h3>
                                ...
                                <span className="border-shape my-3"></span>
                                <p>Dramatically envisioneer functionalized catalysts for change without meta-services.</p>
                                <div className="article-footer d-flex align-items-center justify-content-between">
                                    <div className="article-comments">
                                        <span><i className="fas fa-comment mr-1"></i> 34 Comments</span>
                                    </div>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <a className="single-blog-article rounded bg-white border d-block mt-4" href="/blog-details">
                            <div className="blog-img mb-2">
                                <img src="/assets/img/blog/6.jpg" className="rounded-top img-fluid" alt="blog" />
                            </div>
                            <div className="blog-content-wrap p-4">
                                <div className="article-heading">
                                    <h3 className="h5 mb-0">Seamlessly evolve interactive </h3>
