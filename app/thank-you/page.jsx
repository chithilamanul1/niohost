  ...
  return (
    ...
    <div className="main">
        ...
        <section className="ptb-100 bg-image full-height" data-overlay="8">
            <div className="background-image-wraper" style={{ background: 'url(assets/img/hero-8.jpg)' }}></div>
                ...
                <div className="row align-items-center justify-content-center">
                    <div className="col-12 col-md-9 col-lg-7">
                        <div className="hero-content-left text-white text-center">
                            ...
                            <div className="mb-5">
                                <h5 className="mb-0 text-white"> <span className="fas fa-phone me-2 align-items-center"></span>
                                    (612)
                                    255-461</h5>
                            </div>
                        </div>
