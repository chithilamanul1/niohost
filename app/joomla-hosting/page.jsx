                ...
                <div className="row align-items-center justify-content-lg-between">
                    <div className="col-md-8 col-lg-6">
                        <div className="hero-content-wrap text-white">
                            ...
                            <h1 className="text-white">Unlimited Joomla web hosting with 100% SSD Supported</h1>
                            <ul className="list-unstyled tech-feature-list">
                                <li className="py-1"><span className="fas fa-check-circle text-success me-2"></span>Industry-leading
                                    Performance & Speed</li>
                                <li className="py-1"><span className="fas fa-check-circle text-success me-2"></span>Free & Effortless
                                    Migration</li>
                                <li className="py-1"><span className="fas fa-check-circle text-success me-2"></span>Free SSL
                                    Certificates For ALL Websites</li>
                                <li className="py-1"><span className="fas fa-check-circle text-success me-2"></span>30-day Money-back
                                    Guarantee</li>
                            </ul>
                            <div className="action-btns mt-2">
                                <a href="#" className="btn btn-tertiary mt-3">Get Started Now</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-5 d-none d-md-none d-lg-block">
                        <div className="image-wrap">
                            <img src="/assets/img/hero-joomla-hosting.svg" width="550" alt="wordpress" className="img-fluid" />
                        </div>
                    </div>
                </div>
            </div>
