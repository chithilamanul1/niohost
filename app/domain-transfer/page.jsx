                ...
                <div className="row align-items-center justify-content-lg-between">
                        ...
                        <div className="hero-content-wrap text-white position-relative">
                            ...
                            <div className="domain-transfer-wrap mt-4">
                                <form action="domain-search-result.php" className="domain-transfer-form newsletter-form position-relative w-75">
                                    ...
                                    <button type="submit" className="btn btn-tertiary">Transfer</button>
                                </form>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-6">
                        <div className="img-wrap text-lg-end">
                            <img src="assets/img/domain-transfer.svg" alt="domain registration" className="img-fluid" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="features" className="feature-tab-section ptb-100 ">
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-md-6 col-lg-6">
                        <div className="cta-new-wrap">
                            ...
                            <p className="lead">Once you have everything you need, perform these 4 simple steps, proactively partnerships with worldwide products.</p>
                            <ul className="list-unstyled tech-feature-list">
                                <li className="py-1"><span className="me-2 h5">1.</span>Enter the domain name you want to
                                    transfer.</li>
                                <li className="py-1"><span className="me-2 h5">2.</span>Proceed with the purchase.</li>
                                <li className="py-1"><span className="me-2 h5">3.</span>Enter the EPP code.</li>
                                <li className="py-1"><span className="me-2 h5">4.</span>Confirm your transfer.</li>
                            </ul>
                            <div className="action-btns mt-4">
                                <a href="#" className="btn btn-outline-primary">Get Started Now</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-6">
                        <div className="cta-new-wrap">
                            <img src="assets/img/hero-img.png" alt="hosting" className="img-fluid" />
                        </div>
                    </div>
                </div>
                <div className="row align-items-center mt-5">
                    <div className="col-md-6 col-lg-6">
                        <div className="cta-new-wrap">
                            <img src="assets/img/create-website.svg" alt="hosting" className="img-fluid" />
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-6">
                        <div className="cta-new-wrap">
                            <h2>Before transferring your domain, make sure of the following</h2>
                            <p className="lead">Phosfluorescently fashion front-end web-readiness vis-a-vis robust fabricate scalable web-readiness technologies. </p>
                            <ul className="list-unstyled tech-feature-list">
                                <li className="py-1"><span className="fas fa-check-circle text-success me-2"></span>It's been
                                    more than 60 days since the domain registration or last transfer.</li>
                                <li className="py-1"><span className="fas fa-check-circle text-success me-2"></span>Domain is not
                                    in Pending Delete or Redemption status.</li>
                                <li className="py-1"><span className="fas fa-check-circle text-success me-2"></span>The
                                    authorisation code that proves your ownership of the domain. </li>
                                <li className="py-1"><span className="fas fa-check-circle text-success me-2"></span>You can get
                                    the EPP code from the current domain provider.</li>
                                <li className="py-1"><span className="fas fa-check-circle text-success me-2"></span>Whois privacy
                                    protection is disabled.</li>
                                <li className="py-1"><span
                                className="fas fa-check-circle text-success me-2"></span>Enthusiastically extend worldwide e-services.</li>
                                <li className="py-1"><span
                                className="fas fa-check-circle text-success me-2"></span>Professionally develop holistic solutions.</li>
                            </ul>
                            <div className="action-btns mt-4">
