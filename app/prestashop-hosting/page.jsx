...
export default function prestashophostingPage() {
  return (
    <>
    ...
    <div className="main">
                ...
                <div className="row align-items-center justify-content-lg-between">
                    <div className="col-md-6 col-lg-5">
                        <div className="hero-content-wrap text-white position-relative">
                            <h1 className="text-white">Unlimited Prestashop Web Hosting with 100% SSD</h1>
                    ...
                    <div className="col-md-6 col-lg-6">
                        <div className="img-wrap text-lg-end">
                            <img src="/assets/img/prestashop-hosting.svg" alt="email hosting" className="img-fluid" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section className="appliction-hosting mt-n-90 ">
            <div className="container">
