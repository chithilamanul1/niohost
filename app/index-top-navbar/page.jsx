...
export default function indextopnavbarPage() {
  return (
    <>
    ...
    <div id="header-top-bar" className="top-bar gray-light-bg pb-1">
        <div className="container">
            <div className="row align-items-center justify-content-center">
                <div className="col-md-6 col-lg-5 d-none d-lg-block d-md-block">
                    <ul className="list-unstyled list-inline topbar-nav topbar-nav-left">
                        <li className="list-inline-item">
                            <i className="fas fa-phone me-1"></i>
                            Sales:
                            <a href="tel:0208 050 1337">0208 050 1337</a>
                        </li>
                        <li className="list-inline-item">
                ...
                <div className="col-md-6 col-lg-7">
                    <ul className="list-unstyled list-inline topbar-nav topbar-nav-right text-lg-end">
                        <li className="list-inline-item"><a href="/about-us">About</a></li>
                        <li className="list-inline-item"><a href="/blog-grid">Blog</a></li>
                        <li className="list-inline-item">
                            <a href="#">
    ...
    <header id="header" className="header-main position-relative">
    ...
    <div className="main">
        ...
        <section className="ptb-100 overflow-hidden hero-equal-height primary-bg">
            <div className="container">
                    ...
                    <div className="col-md-12 col-lg-5">
                        <div className="hero-slider-content text-white py-5">
                            ...
                            <div className="action-btns mt-4">
                                <a href="#" className="btn btn-tertiary btn-lg">Get Started Now </a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row align-items-center justify-content-md-center justify-content-center">
                    <div className="col-lg-4 col-md-6 col-sm-8">
                        <div className="text-center bg-white single-pricing-pack-2 mt-4 rounded border">
                            ...
                            <a href="#" className="btn btn-primary mt-3">Get Started Now</a>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6 col-sm-8">
                    ...
                    <div className="col-12">
                        <div className="support-cta text-center mt-5">
                            ...
                            <p>
                                Have some questions? <a href="/contact-us">Chat with us now</a>, or
                                <a href="/contact-us">send us an email</a> to get in touch.
                            </p>
                        </div>
                    </div>
                </div>
