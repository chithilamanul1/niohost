...
export default function networkPage() {
  return (
    ...
    <div className="main">
        ...
        <section className="ptb-120 gradient-bg position-relative min-vh-100 flex-column d-flex justify-content-center">
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-10 col-lg-8 col-xl-7">
                        <div className="hero-content-wrap text-white text-center position-relative">
                            <h1 className="text-white">More Then 150 Ultra-Fast Data Center Worldwide</h1>
                        ...
                        <div className="network-map-wrap mt-5">
