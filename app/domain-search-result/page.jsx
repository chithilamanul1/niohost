...
export default function domainsearchresultPage() {
  return (
    <>
                ...
                <div className="row justify-content-center">
                    <div className="col-md-9 col-lg-8">
                        <div className="hero-content-left text-white text-center">
                            ...
                            <form action="domain-search-result.php" className="domain-transfer-form newsletter-form position-relative mt-3 w-75 d-block mx-auto">
                                <input type="text" name="domain" id="domain" className="form-control rounded-pill" placeholder="yourdomainname.com" />
                    ...
                    <div className="col-lg-3">
                        <div className="domain-extension-filter-wrap p-4 white-bg rounded">
                            <div className="domain-filter-title">
                                <h5 className="mb-0 d-flex">Filter Results <span
                                className="fas fa-angle-down ms-auto text-end"></span></h5>
                            </div>
                            <ul className="list-unstyled domain-filter-list mt-3">
                                ...
                                <button type="submit" className="btn btn-block btn-outline-primary w-100 btn-sm mt-3">Apply</button>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <tr className="vps-pricing-row">
                                        ...
                                        <td>
                                            <p>
                                                ...
                                                <span className="pricing-onsale">On sale -
                                            <span className="badge bg-warning">Save 30%</span></span>
                                            </p>
                                        </td>
                                        <td>
                                ...
                                <tbody>
                                    ...
                                    <tr className="vps-pricing-row">
                                        ...
                                        <td data-value="Price">
                                            <p>
                                                ...
                                                <span className="pricing-onsale">On sale -
                                            <span className="badge bg-warning">Save 50%</span></span>
                                            </p>
                                        </td>
                                        <td>
                                            <a href="" className="btn btn-primary btn-sm">Add to Cart</a>
                                    ...
                                    <tr className="vps-pricing-row">
                                        ...
                                        <td data-value="Price">
                                            <p>
                                                ...
                                                <span className="pricing-onsale">On sale -
                                            <span className="badge bg-warning">Save 10%</span></span>
                                            </p>
                                        </td>
                                        <td>
                                            <a href="" className="btn btn-primary btn-sm">Add to Cart</a>
                                    ...
                                    <tr className="vps-pricing-row">
                                        ...
                                        <td data-value="Price">
                                            ...
                                            className="badge bg-warning">Save 30%</span></span></p>
                                        </td>
                                        <td>
                                            <a href="" className="btn btn-primary btn-sm">Add to Cart</a>
                                        </td>
                                    ...
                                    <tr className="vps-pricing-row">
                                        ...
                                        <td data-value="Price">
                                            ...
                                            className="badge bg-warning">Save 40%</span></span></p>
                                        </td>
                                        <td>
                                            <a href="" className="btn btn-primary btn-sm">Add to Cart</a>
                                        </td>
                                    ...
                                    <tr className="vps-pricing-row">
                                        ...
                                        <td data-value="Price">
                                            ...
                                            className="badge bg-warning">Save 10%</span></span></p>
                                        </td>
                                        <td>
                                            <a href="" className="btn btn-primary btn-sm">Add to Cart</a>
                                        </td>
        ...
        <section className="feature-tab-section ptb-100 ">
            <div className="container">
                <div className="row">
                    <div className="col-xl-6 col-lg-6 col-12 order-lg-last">
                        <div className="image-box fadein text-xl-right text-center">
                            <img src="assets/img/network-1.jpg" alt="wp-hosting" className="img-fluid rounded" />
                        </div>
                    </div>
                ...
                <div className="row justify-content-between mt-5">
                    <div className="col-xl-6 col-lg-6 col-12 order-lg-last">
                        <div className="image-box fadein text-xl-right text-center">
                            <img src="assets/img/network-2.jpg" alt="wp-hosting" className="img-fluid rounded" />
                        </div>
                    </div>
