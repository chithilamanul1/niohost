...
export default function pricingwindowshostingPage() {
  return (
    <>
                ...
                <div className="row justify-content-center">
                    <div className="col-md-9 col-lg-6">
                        <div className="section-heading text-center mb-4">
                            <h2>Choose Your Windows VPS Plan</h2>
                            <p>
                ...
                <div className="row align-items-center justify-content-md-center justify-content-center">
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="bg-white single-pricing-pack mt-4 border">
                            <div className="text-center pricing-header py-4">
                                ...
                                <div className="price mb-0 monthly-price color-secondary"><span>$</span>19.99</div>
                            ...
                            <div className="pricing-content text-center">
                                <ul className="list-unstyled mb-4 pricing-feature-list">
                                    ...
                                    <li><span>50 GB</span> Storage</li>
                                    <li><span>4 TB</span> Bandwidth</li>
                                    <li><span>24/7</span> Support</li>
                                    <li><span>4</span> Cores</li>
                                </ul>
                                <div className="text-center">
                                    <a href="#" className="btn btn-primary mb-2" target="_blank">Purchase now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="popular-price bg-white single-pricing-pack mt-4 border">
                            <div className="text-center pricing-header py-4 text-white">
                                <h6 className="mb-2 h5 text-white text-uppercase">Windows VPS 2</h6>
                                <div className="price mb-0 monthly-price"><span>$</span>45.99</div>
                                <span className="p-month"> Per Month</span>
                            </div>
                            <div className="pricing-content text-center">
                                <ul className="list-unstyled mb-4 pricing-feature-list">
                                ...
                                <div className="text-center">
                                    <a href="#" className="btn btn-tertiary mb-2" target="_blank">Purchase now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="bg-white single-pricing-pack mt-4 border">
                            <div className="text-center pricing-header py-4">
                                ...
                                <div className="price  mb-0 monthly-price color-secondary"><span>$</span>66.99</div>
                                <span className="p-month"> Per Month</span>
                            </div>
                            <div className="pricing-content text-center">
                                <ul className="list-unstyled mb-4 pricing-feature-list">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="bg-white single-pricing-pack mt-4 border">
                            <div className="text-center pricing-header py-4">
                                ...
                                <div className="price mb-0 monthly-price color-secondary"><span>$</span>99.99</div>
                                <span className="p-month"> Per Month</span>
                            </div>
                            <div className="pricing-content text-center">
                                <ul className="list-unstyled mb-4 pricing-feature-list">
                                    <li><span>16 GB</span> RAM</li>
                                    <li><span>400 GB</span> Storage</li>
                                    <li><span>7 TB</span> Bandwidth</li>
                                    <li><span>24/7</span> Support</li>
                                    <li><span>4</span> Cores</li>
                                </ul>
                                <div className="text-center">
                    ...
                    <div className="col-12">
                        <div className="support-cta text-center mt-5">
                            <h5 className="mb-1"><span className="fas fa-headset color-primary me-3"></span>We're Here to Help You
                            </h5>
                            <p>Have some questions? <a href="/contact-us">Chat with us now</a>, or <a href="/contact-us">send us an email</a> to
                                get in touch.</p>
                        </div>
                    </div>
                </div>
