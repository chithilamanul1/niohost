                            ...
                            <div className="post-wrapper">
                                ...
                                <div className="post-footer">
                                    <div className="post-tags">
                                        <a href="#">Lifestyle</a><a href="#">Music</a><a href="#">News</a><a href="#">Travel</a>
                                    </div>
                                </div>
                            </div>
                        </article>
                                ...
                                <div className="comment">
                                    ...
                                    <div className="comment-body">
                                        ...
                                        <div className="comment-content">
                                            <p>
                                                Meh synth Schlitz, tempor duis single-origin coffee ea next
                                                level ethnic fingerstache fanny pack nostrud. Seitan High
                                                Life reprehenderit consectetur cupidatat kogi about me.
                                            ...
                                            <div className="comment-body">
                                                ...
                                                <div className="comment-content">
                                                    <p>
                                                        ...
                                                        kogi about me. Photo booth anim 8-bit hella.
                                                    </p>
                                                </div>
                                                <div className="comment-reply"><a href="#">Reply</a></div>
                                            </div>
                            ...
                            <div className="comment-respond">
                                ...
                                <form className="comment-form row">
                                    ...
                                    <div className="form-group col-md-12 mb-3">
                                        <textarea className="form-control h-100" rows="8" placeholder="Comment"></textarea>
                                    </div>
                                    <div className="form-submit col-md-12 mb-3">
                    ...
                    <div className="col-lg-4 col-md-4">
                        <div className="sidebar-right pl-4">
                            ...
                            <aside className="widget widget-categories">
                                ...
                                <ul>
                                    <li>
                                        <a href="#">Journey <span className="float-right">112</span></a>
                                    </li>
                                    <li>
                                        <a href="#">Development <span className="float-right">86</span></a>
                                    </li>
                                    <li>
                                        <a href="#">Sport <span className="float-right">10</span></a>
                                    </li>
                                    <li>
                                        <a href="#">Photography <span className="float-right">144</span></a>
                                    </li>
                                    <li>
                                        <a href="#">Symphony <span className="float-right">18</span></a>
                                    </li>
                                </ul>
                            </aside>
                                    ...
                                    <li className="clearfix">
                                        ...
                                        <div className="wb">
                                            <a href="/blog-details">Map where your photos were taken and discover local
                                                points.</a><span className="post-date">May 8, 2016</span>
                                        </div>
                                    </li>
                                    <li className="clearfix">
                                        <div className="wi">
                            ...
                            <aside className="widget widget-tag-cloud">
                                ...
                                <div className="tag-cloud">
                                    <a href="#">e-commerce</a><a href="#">portfolio</a><a href="#">responsive</a><a href="#">bootstrap</a><a href="#">business</a><a href="#">corporate</a>
                                </div>
                            </aside>
                        </div>
                    </div>
