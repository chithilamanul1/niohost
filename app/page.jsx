                    ...
                    <div className="col-md-12 col-lg-5">
                        <div className="hero-slider-content text-white py-5">
                            <div className="headline mb-4">
                                <p className="mb-0"><i className="fas fa-bell rounded-circle mr-2"></i> <span className="fw-bold">30% Discount
                            ...
                            <div className="action-btns mt-4">
                                <a href="#" className="btn btn-tertiary btn-lg">NULLPHPSCRIPT.COM </a>
                            </div>
                        </div>
                    </div>
