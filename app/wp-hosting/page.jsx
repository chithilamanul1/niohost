...
export default function wphostingPage() {
  return (
    <>
    ...
    <div className="main">
                ...
                <div className="row align-items-center justify-content-lg-between">
                    <div className="col-md-6 col-lg-5">
                        <div className="hero-content-wrap text-white position-relative">
                            <h1 className="text-white">Premium WordPress Hosting for Everyone</h1>
                            ...
                            <a href="#" className="btn btn-tertiary btn-lg mt-3">Get Start Now</a>
                        </div>
                    </div>
        ...
        <section className="appliction-hosting mt-n-65 ">
            <div className="container">
        ...
        <section className="wp-pricing-section ptb-100">
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-9 col-lg-6">
                        <div className="section-heading text-center">
                            <h2>High Performance WordPress Hosting</h2>
                            <p>Our hosting plans all come with WordPress pre-installed, securely hosted and backed by our 24x7 expert support, get started with WordPress.</p>
                        </div>
                    </div>
                </div>
                <div className="row">
                    <div className="wp-price-wrap" style={{ background: 'url(assets/img/wordpress-icon-color.svg)' }}>
                        <div className="wp-single-price">
                            ...
                            <ul className="wp-price-feature-list">
                                ...
                                <li className="py-1"><i className="far fa-check fa-lg text-success mr-2"></i> <span>The perfect place to start for an all-in-one Wordpress Hosting solution.</span></li>
                                <li className="py-1"><i className="far fa-check fa-lg text-success mr-2"></i> <span>It’s stable, fast, well supported and offers superb value.</span></li>
                                <li className="py-1"><i className="far fa-check fa-lg text-success mr-2"></i> <span>Highly secured, with fast loading times and 24/7 support</span></li>
                                <li className="py-1"><i className="far fa-check fa-lg text-success mr-2"></i> <span>Install unlimited themes and plug-ins</span></li>
                            </ul>
                            <div className="wp-price-action mt-4">
                                <h4 className="h5 color-primary mb-0">Start From</h4>
                                <span className="h2 price d-block">$5.5 <small>/mo</small></span>
                                <a href="#" className="btn btn-primary btn-lg">Buy WordPress Hosting</a>
                            </div>
                        </div>
                        <div className="wp-single-price">
                            <div className="wp-price-head mb-4">
                            ...
                            <ul className="wp-price-feature-list">
                                ...
                                <li className="py-1"><i className="far fa-check fa-lg text-success mr-2"></i> <span>Built from the ground up using nearly two decades of hosting experience.</span></li>
                                <li className="py-1"><i className="far fa-check fa-lg text-success mr-2"></i> <span>The pinnacle of WordPress Hosting coupled with next-level management.</span></li>
                                <li className="py-1"><i className="far fa-check fa-lg text-success mr-2"></i> <span>Application catalog for 1-click installations (Softaculous installer)</span></li>
                                <li className="py-1"><i className="far fa-check fa-lg text-success mr-2"></i> <span>Expert consultancy transformative solutions</span></li>
                            </ul>
                            <div className="wp-price-action mt-4">
                                <h4 className="h5 color-primary mb-0">Start From</h4>
                                <span className="h2 price d-block">$4.5 <small>/mo</small></span>
                                <a href="#" className="btn btn-primary btn-lg">Buy WordPress Hosting</a>
                            </div>
                        </div>
                    </div>
