...
export default function vpshostingPage() {
  return (
    ...
    <div className="main">
                ...
                <div className="row align-items-center justify-content-lg-between">
                    ...
                    <div className="col-md-5 col-lg-6">
                        <div className="img-wrap text-lg-end">
                            <img src="/assets/img/hero-vps-hosting.svg" alt="vps image" className="img-fluid" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="custom-plan" className="custom-plan gray-light-bg ptb-100">
            <div className="container">
                    ...
                    <div className="col-md-9 col-lg-6">
                        <div className="section-heading text-center mb-5">
                            ...
                            <p>
                                ...
                                relationships. Enthusiastically deliver competitive systems and
                                client-centric.
                            </p>
                        </div>
                    </div>
                ...
                <div className="row justify-content-center">
                    <div className="col-md-12 col-lg-10">
                        <div className="vps-switch-wrap">
                            <div className="row justify-content-around">
                                <div className="col-sm-8">
                                    <div className="custom-plan-box bg-white rounded border">
                                ...
                                <div className="col-sm-4">
                                    <a href="#" className="btn btn-tertiary btn-lg btn-block w-100 vpsWHmcsUrl">
                                        Order Now</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="col-sm-12 col-lg-8">
                                <div className="row g-2">
                                    <div className="col-lg-6 col-md-6">
                                        <div className="single-vps-item rounded border bg-white text-center d-flex align-items-center">
                                            <span
                          className="fas fa-shield-alt icon-size-md color-primary p-3"
                      ></span>
                                            <div className="vps-item-info pl-3">
                                                <h6 className="d-block mb-1 text-muted">Core</h6>
                                                <h3 className="mb-0 feature vpsCore"><span>1</span> GB</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-6 col-md-6">
                                        <div className="single-vps-item rounded border bg-white text-center d-flex align-items-center">
                                            <span
                          className="fas fa-memory icon-size-md color-primary p-3"
                      ></span>
                                            <div className="vps-item-info pl-3">
                                                <h6 className="d-block mb-1 text-muted">Memory</h6>
                                                <h3 className="mb-0 feature vpsMemory">
                                                    <span>2</span> GB
                                                </h3>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-lg-6 col-md-6">
                                        <div className="single-vps-item rounded border bg-white text-center d-flex align-items-center">
                                            <span
                          className="far fa-hard-drive icon-size-md color-primary p-3"
                      ></span>
                                            <div className="vps-item-info pl-3">
                                                <h6 className="d-block mb-1 text-muted">Storage</h6>
                                                <h3 className="mb-0 feature vpsStorage">
                                                    <span>10</span> GB
                                                </h3>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-lg-6 col-md-6">
                                        <div className="single-vps-item rounded border bg-white text-center d-flex align-items-center">
                                            <span
                          className="fas fa-wifi icon-size-md color-primary p-3"
                      ></span>
                                            <div className="vps-item-info pl-3">
                                                <h6 className="d-block mb-1 text-muted">Bandwidth</h6>
                                                <h3 className="mb-0 feature vpsBandwidth">
                                                    <span>1000</span> TB
                                                </h3>
                                            </div>
                                        </div>
                            ...
                            <div className="col-sm-12 col-lg-4">
                                <div className="custom-plan-info-box text-center bg-white rounded border">
                                    <h3>Price</h3>
                                    <div className="vpsPrice h1 mb-0 color-primary">$20</div>
                ...
                <div className="row justify-content-center">
                    <div className="col-md-9 col-lg-6">
                        <div className="section-heading text-center mb-5">
                            ...
                            <p>Uniquely restore open-source products via open-source relationships.
                                ...
                                <tr className="vps-pricing-row gray-light-bg">
                                    ...
                                    <td data-value="Geekbench Score">
                                        <div className="score-bar-wrap">
                                            ...
                                            <div className="progress w-100 score-bar-item">
                                                <div className="progress-bar primary-bg" role="progressbar"  aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">30%
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td data-value="Price">
                                        <p className="mb-0">
                                            ...
                                            <span className="pricing-onsale">On sale - <span className="badge bg-success">Save
                                      30%</span></span>
                                        </p>
                                    </td>
                                    <td>
                                ...
                                <tr className="vps-pricing-row gray-light-bg">
                                    ...
                                    <td data-value="Geekbench Score">
                                        <div className="score-bar-wrap">
                                            ...
                                            <div className="progress w-100 score-bar-item">
                                                <div className="progress-bar primary-bg" role="progressbar"  aria-valuenow="45" aria-valuemin="0" aria-valuemax="100">40%
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr className="vps-pricing-row gray-light-bg">
                                    ...
                                    <td data-value="Geekbench Score">
                                        <div className="score-bar-wrap">
                                            ...
                                            <div className="progress w-100 score-bar-item">
                                                <div className="progress-bar primary-bg" role="progressbar"  aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">60%
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr className="vps-pricing-row gray-light-bg">
                                    ...
                                    <td data-value="Geekbench Score">
                                        <div className="score-bar-wrap">
                                            ...
                                            <div className="progress w-100 score-bar-item">
                                                <div className="progress-bar primary-bg" role="progressbar"  aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">75%
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td data-value="Price">
                                      ...
                                      className="badge bg-success">Save 30%</span></span></p>
                                    </td>
                                    <td>
                                        <a href="" className="btn btn-primary btn-sm">Order Now</a>
                                    </td>
                                ...
                                <tr className="vps-pricing-row gray-light-bg">
                                    ...
                                    <td data-value="Geekbench Score">
                                        <div className="score-bar-wrap">
                                            ...
                                            <div className="progress w-100 score-bar-item">
                                                <div className="progress-bar primary-bg" role="progressbar"  aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">85%
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td data-value="Price">
                                      ...
                                      className="badge bg-success">Save 40%</span></span></p>
                                    </td>
                                    <td>
                                        <a href="" className="btn btn-primary btn-sm">Order Now</a>
                                    </td>
                                ...
                                <tr className="vps-pricing-row gray-light-bg">
                                    ...
                                    <td data-value="Geekbench Score">
                                        <div className="score-bar-wrap">
                                            ...
                                            <div className="progress w-100 score-bar-item">
                                                <div className="progress-bar primary-bg" role="progressbar"  aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">100%
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td data-value="Price">
                                      ...
                                      className="badge bg-success">Save 10%</span></span></p>
                                    </td>
                                    <td>
                                        <a href="" className="btn btn-primary btn-sm">Order Now</a>
                                    </td>
        ...
        <section className="feature-section ptb-100 gray-light-bg">
            <div className="container">
                ...
                <div className="row align-items-center justify-content-between">
                    <div className="col-md-6 col-lg-6">
                        <div className="cta-new-wrap">
                            <div className="feature-feature-list py-3">
                                <span className="fas fa-hard-drive icon-size-md d-block color-primary mb-3"></span>
                            ...
                            <div className="feature-feature-list py-3">
                                <span className="fas fa-network-wired icon-size-md d-block color-primary mb-3"></span>
                            ...
                            <div className="feature-feature-list py-3">
                                <span className="fas fa-lock icon-size-md d-block color-primary mb-3"></span>
                    ...
                    <div className="col-md-6 col-lg-6">
                        <div className="cta-new-wrap">
                            <img src="/assets/img/vps-feature-img-1.png" alt="hosting" className="img-fluid" />
                        </div>
                    </div>
                </div>
                <div className="row align-items-center justify-content-between mt-5">
                    <div className="col-md-6 col-lg-6">
                        <div className="cta-new-wrap">
                            <img src="/assets/img/vps-feature-img-2.png" alt="hosting" className="img-fluid" />
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-6">
                        <div className="cta-new-wrap">
                            <div className="feature-feature-list py-3">
                                <span className="fas fa-globe-americas icon-size-md d-block color-primary mb-3"></span>
                            ...
                            <div className="feature-feature-list py-3">
                                <span className="fas fa-location-pin icon-size-md d-block color-primary mb-3"></span>
                            ...
                            <div className="feature-feature-list py-3">
                                <span className="fas fa-credit-card icon-size-md d-block color-primary mb-3"></span>
