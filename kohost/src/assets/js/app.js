...
(function ($) {
  ...
  // 7. our clients logo carousel
  const clientsSlider = new Swiper('.clients-carousel', {
    loop: true,
    autoplay: {
      delay: 4500,
      disableOnInteraction: false,
    },
    speed: 4500, // Matches autoplaySpeed
    spaceBetween: 15, // Matches margin
    slidesPerView: 6, // Default number of items
    breakpoints: {
      0: {
  ...
  //hero gaming slider
  // Initialize Swiper
const indicatorSlider = new Swiper('.custom-indicator-slider', {
  loop: true,
  speed: 1000,
  pagination: {
  ...
  // 9. client-testimonial one item carousel
  const feedbackOne = new Swiper(".client-testimonial-1", {
    loop: true,
    autoplay: {
  ...
  const feedbackTwo = new Swiper(".client-testimonial-2", {
    loop: true,
    autoplay: {
  ...
  // 10. client-testimonial one item carousel
  const heroContentSlider = new Swiper(".hero_content_slider", {
    loop: true,
    autoplay: {
      delay: 3000, // Set autoplay delay
      disableOnInteraction: false, // Continue autoplay after interaction
  ...
  // 16. hero slider one
  const hsOne = new Swiper('.hero-slider-one', {
    loop: true,
    autoplay: {
      delay: 3000,
      disableOnInteraction: false,
    },
    speed: 1000, // Match smartSpeed
    effect: 'fade', // Alternative to animateOut/animateIn
    fadeEffect: {
      crossFade: true,
    },
  });
