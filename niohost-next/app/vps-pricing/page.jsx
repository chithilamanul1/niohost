                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div className="offer-block gradient-bg d-flex align-items-center justify-content-between px-5 py-4 position-relative z-index">
                            ...
                            <div className="offer-btn text-white">
                                <a href="#" className="btn btn-tertiary offer-link">Get Offer</a>
                            </div>
                        </div>
                                ...
                                <tr className="vps-pricing-row">
                                    ...
                                    <td data-value="Price">
                                        <p>
                                            ...
                                            <span className="pricing-onsale">On sale - <span className="badge bg-warning">Save 30%</span></span>
                                        </p>
                                    </td>
                                    <td>
                                        <a href="" className="btn btn-primary btn-sm">Order Now</a>
                                ...
                                <tr className="vps-pricing-row">
                                    ...
                                    <td data-value="Price">
                                        <p>
                                            ...
                                            <span className="pricing-onsale">On sale - <span className="badge bg-warning">Save 50%</span></span>
                                        </p>
                                    </td>
                                    <td>
                                        <a href="" className="btn btn-primary btn-sm">Order Now</a>
                                ...
                                <tr className="vps-pricing-row">
                                    ...
                                    <td data-value="Price">
                                        <p>
                                            ...
                                            <span className="pricing-onsale">On sale - <span className="badge bg-warning">Save 10%</span></span>
                                        </p>
                                    </td>
                                    <td>
                                        <a href="" className="btn btn-primary btn-sm">Order Now</a>
