                ...
                <div className="row align-items-center justify-content-lg-between">
                    <div className="col-md-7 col-lg-5">
                        <div className="hero-content-wrap text-white">
                            <h1 className="text-white">Managed Your Cloud Hosting by Experts</h1>
                            <p className="lead">Web hosting made choose a fine-tuned hosting services solution for successful personal and business websites.</p>
                            <a href="#" className="btn btn-tertiary btn-lg mt-3">NULLPHPSCRIPT.COM</a>
                        </div>
                    </div>
                    <div className="col-md-5 col-lg-6">
                        <div className="img-wrap text-lg-end">
                            <img src="assets/img/hero-cloud-hosting.svg" alt="vps image" className="img-fluid" />
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table className="table w-100 table-hover table-bordered comparision-table text-center">
                                <thead className="comparision-table-head">
                                    <tr className="active">
                                        ...
                                        className="badge bg-warning ms-1">Popular</span></strong>
                                ...
                                <tbody className="comparision-table-body">
                                    <tr>
                                        ...
                                        <td className="py-4">
                                            ...
                                            <a href="#" className="btn btn-primary btn-sm mt-2">Get Started</a>
                                        </td>
                                        <td className="py-4">
                                    ...
                                    <tr>
                                        ...
                                        <td><span className="far fa-check-circle color-primary"></span></td>
                                        <td><span className="far fa-check-circle color-primary"></span></td>
                                        <td><span className="far fa-check-circle color-primary"></span></td>
                                    </tr>
                                    <tr>
        ...
        <section className="feature-tab-section ptb-100 ">
            <div className="container">
                <div className="row">
                    <div className="col-md-6 col-lg-6">
                        <div className="cta-new-wrap">
                            <img src="assets/img/easy-to-transfer.svg" alt="hosting" className="img-fluid" />
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-6">
                        <div className="cta-new-wrap">
                            <h2>The Perfect Environment For Your Success</h2>
                            <div className="feature-feature-list py-3">
                                <h5 className="mb-2">Room for Growth</h5>
                            ...
                            <div className="feature-feature-list py-3">
                                <h5 className="mb-2">3x More Speed</h5>
                            ...
                            <div className="feature-feature-list py-3">
                                <h5 className="mb-2">Powerful Control Panel</h5>
