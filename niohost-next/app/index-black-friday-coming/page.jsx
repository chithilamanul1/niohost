...
export default function indexblackfridaycomingPage() {
  return (
    <>
    ...
    <div className="main">
        ...
        <section className="ptb-120 position-relative min-vh-100 flex-column d-flex justify-content-center gradient-overlay bg-image">
            <div className="background-image-wraper custom-overlay" ></div>
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-9 col-lg-8">
                        <div className="hero-content-left text-white text-center position-relative">
                            <h3 className="text-white">Black Friday Sale!</h3>
                            <h1 className="text-white big-text"><span>UP TO</span> 90% OFF</h1>
                            <p className="lead">Web Hosting & Free Domain</p>
                            <a href="#" className="btn btn-tertiary btn-lg my-3">Get Started Now</a>
                            <p>Hurry Up, Limited time offer is ticking down</p>
                            <ul className="list-unstyled list-inline countdown-wrap-2 pt-5">
                                <li className="list-inline-item mb-0">
                                    <span
                                  className="counter-days text-light p-3 border h2 rounded fw-medium"></span>
                                </li>
                                <li className="list-inline-item mb-0">
                                    <span
                                  className="counter-hours text-light p-3 border h2 rounded fw-medium"></span>
                                </li>
                                <li className="list-inline-item mb-0">
                                    <span
                                  className="counter-minutes text-light p-3 border h2 rounded fw-medium"></span>
                                </li>
                                <li className="list-inline-item mb-0">
                                    <span
                                  className="counter-seconds text-light p-3 border h2 rounded fw-medium"></span>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <footer className="footer-1 ptb-60 dark-bg ">
        <div className="container">
            <div className="row">
