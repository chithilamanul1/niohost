...
export default function indexsliderPage() {
  return (
    <>
    ...
    <div className="main">
        ...
        <section className="hero-slider-section bg-image hero-equal-height ptb-120 dark-bg" data-overlay="8">
            <div className="background-image-wraper" style={{ background: 'url(assets/img/hero-1.jpg)' }}></div>
            <div className="container">
                <div className="hero_content_slider swiper">
                                ...
                                <div className="row align-items-center justify-content-lg-between">
                                    <div className="col-md-12 col-lg-6">
                                        <div className="hero-content-wrap text-white position-relative z-index">
                                            <span className="text-white h5 mb-3">Reliable hosting to make any website</span>
                                            <h1 className="text-white">We Offer Shared Hosting Fast, Secure & Easy To Manage</h1>
                                            <ul className="list-unstyled tech-feature-list">
                                                <li className="py-1"><span className="fas fa-check-circle text-info me-2"></span><strong>
                                            ...
                                            <div className="action-btns mt-4">
                                                ...
                                                <a href="#" className="btn btn-tertiary mr-3">Get Started Now</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-5 d-none d-md-none d-lg-block">
                                        <div className="big-price-wrap position-relative">
                                            ...
                                            <span className="d-block text-white regular-price text-center">Regular Price <strong>$10.99</strong> *</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row align-items-center justify-content-lg-between">
                                    <div className="col-md-12 col-lg-6">
                                        <div className="hero-content-wrap text-white">
                                            <span className="text-white h5 font-weight-normal">Trusted by 700,500 Website Owners</span>
                                            <h1 className="text-white">Your Websites Deserve Faster, Secure &amp; Reliable Hosting</h1>
                                            <ul className="list-unstyled tech-feature-list">
                                                <li className="py-1"><span className="fas fa-check-circle text-info me-2"></span>Industry-leading Performance
                                                    &amp; Speed</li>
                                                <li className="py-1"><span className="fas fa-check-circle text-info me-2"></span>Free &amp;
                                                    Effortless Migration</li>
                                                <li className="py-1"><span className="fas fa-check-circle text-info me-2"></span>Free SSL
                                                    Certificates For ALL Websites</li>
                                                <li className="py-1"><span className="fas fa-check-circle text-info me-2"></span>99.9%
                                                    Uptime Guarantee</li>
                                                <li className="py-1"><span className="fas fa-check-circle text-info me-2"></span>30-day
                        ...
                        <div className="swiper-slide">
                            <div className="">
                                <div className="row align-items-center justify-content-lg-between">
                                    <div className="col-md-12 col-lg-6">
                                        <div className="hero-content-wrap text-white">
                                            <span className="text-white h5 font-weight-normal">Build your own website</span>
                                            <h1 className="text-white">Own VPS, Fully Managed by Experts, Simple, affordable</h1>
                                            <ul className="list-unstyled tech-feature-list">
                                                <li className="py-1"><span className="fas fa-check-circle text-info me-2"></span>24/7
                                                    fully managed support</li>
                                                <li className="py-1"><span className="fas fa-check-circle text-info me-2"></span>Industry-leading performance
                                                    &amp; load speed</li>
                                                <li className="py-1"><span className="fas fa-check-circle text-info me-2"></span>Robust
                        ...
                        <div className="domain-search-wrap border gray-light-bg">
                            ...
                            <form action="domain-search-result.php" method="GET" className="domain-search-form my-4">
                                ...
                                <div className="select-group">
                                    ...
                                    <button type="submit" className="btn btn-primary"><i className="fas fa-search pe-1"></i> Search
                                    </button>
                                </div>
                            </form>
                        ...
                        <div className="application-icon-wrap p-5 bg-white rounded-3">
                            ...
                            <div className="application-content">
                                ...
                                <div className="read-more-link">
                                    <a href="#" target="_blank" className="d-inline-flex align-items-center btn btn-sm">
                                        <span>Read More</span>
        ...
        <section className="client-section  ptb-100">
            <div className="container">
                ...
                <div className="row align-items-center">
                    <div className="col-md-12">
                        <div className="clients-carousel swiper">
                            <div className="swiper-wrapper">
                                <div className="swiper-slide">
