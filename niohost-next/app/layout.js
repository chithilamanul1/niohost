  ...
  return (
    <html lang="en">
      ...
      <body>
        ...
        <Script src="/assets/js/vendors/bootstrap-slider.min.js" strategy="lazyOnload" />
        <Script src="/assets/js/vendors/swiper-bundle.min.js" strategy="lazyOnload" />
        <Script src="/assets/js/vendors/magnific-popup.min.js" strategy="lazyOnload" />
        <Script src="/assets/js/vendors/validator.min.js" strategy="lazyOnload" />
        <Script src="/assets/js/vendors/hs.megamenu.js" strategy="lazyOnload" />
