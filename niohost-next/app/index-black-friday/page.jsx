...
export default function indexblackfridayPage() {
  return (
    <>
    ...
    <div className="main">
        ...
        <section className="hero-equal-height ptb-120 gradient-overlay bg-image" data-overlay="7">
                ...
                <div className="row justify-content-center justify-content-lg-between justify-content-sm-center align-items-center">
                    <div className="col-md-4 col-lg-5">
                        <div className="hero-content-wrap text-white mb-5 mb-md-0 mb-lg-0">
                            <h1 className="text-uppercase text-white font-weight-bold">Black <span className="text-warning">Friday
                            !</span></h1>
                    ...
                    <div className="col-md-8 col-lg-6">
                        <div className="row">
                            <div className="col-6">
                                <div className="single-offer-box position-relative text-center">
                                    <div className="offer-header text-uppercase h6 p-2 mb-0">Managed Wordpress</div>
                                    ...
                                    <a href="/offer-single-page" className="btn btn-tertiary btn-sm save-now-btn">Save Now <i
                                    className="fas fa-arrow-alt-circle-right pl-1"></i></a>
                                </div>
                            </div>
                            <div className="col-6">
                                <div className="single-offer-box position-relative text-center">
                                    <div className="offer-header text-uppercase h6 p-2 mb-0">Managed VPS</div>
                                    <div className="offer-content text-white">
                                        <span>Starting From</span>
                            ...
                            <div className="col-6">
                                <div className="single-offer-box position-relative text-center">
                                    <div className="offer-header text-uppercase h6 p-2 mb-0">Reseller Hosting</div>
                                    <div className="offer-content text-white">
                                        <span>Starting From</span>
                            ...
                            <div className="col-6">
                                <div className="single-offer-box position-relative text-center">
                                    <div className="offer-header text-uppercase h6 p-2 mb-0">Cloud Hosting</div>
                                    <div className="offer-content text-white">
                                        <span>Starting From</span>
