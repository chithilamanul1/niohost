                    ...
                    <div className="col-md-12 col-lg-12">
                        <div className="content-with-sidebar">
                            <div className="section-heading">
                                <h3>Welcome to Nio Host Terms & conditions</h3>
                                <p className="lead">Effective date: 1 January 2020</p>
                            </div>
                            <div id="nav-id-1" className="pt-5">
                                <p>These terms and conditions outline the rules and regulations for the use of Nio Host's Website.</p> <br />
                                <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Nio Host's website
                                ...
                                <h5>Cookies</h5>
                                <p>We employ the use of cookies. By using Nio Host's website you consent to the use of cookies
                                    in accordance with Nio Host's privacy policy.</p>
                                <p>Most of the modern day interactive web sites
                                    use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
                                    to enable the functionality of this area and ease of use for those people visiting. Some of our
                                    affiliate / advertising partners may also use cookies.</p>
                                <h5>License</h5>
                                <p>Unless otherwise stated, Nio Host and/or it's licensors own the intellectual property rights for
                                    all material on Nio Host. All intellectual property rights are reserved. You may view and/or print
                                    pages from http://Nio Host.com for your own personal use subject to restrictions set in these terms and conditions.</p>
                                <p>You must not:</p>
                                <ol>
                                    <li>Republish material from http://Nio Host.com</li>
                                    <li>Sell, rent or sub-license material from http://Nio Host.com</li>
                                    <li>Reproduce, duplicate or copy material from http://Nio Host.com</li>
                                </ol>
                                <p>Redistribute content from Nio Host (unless content is specifically made for redistribution).</p>
                            </div>
                            <div id="nav-id-2" className="pt-5">
                                ...
                                <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect
                                    ...
                                    the visibility associated with the hyperlink outweighs the absence of Nio Host; and (d) where the
                                ...
                                <p>No use of Nio Host's logo or other artwork will be allowed for linking absent a trademark license
                                    agreement.</p>
                            </div>
